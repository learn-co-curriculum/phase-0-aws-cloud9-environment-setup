...
with your Flatiron School account. Go to the [Flatiron School][] website, click
on your avatar in the upper right corner of the page, then click **Manage
Account**. You can also access this page using the direct URL,
[https://learn.co/account](https://learn.co/account).

![manage Flatiron School account](https://curriculum-content.s3.amazonaws.com/environment-setup/learn-co-manage-account-menu.png)

Once you are on the **Account Management** page, click **Connected Apps**.

![connected apps navigation button](https://curriculum-content.s3.amazonaws.com/environment-setup/learn-co-connect-apps-nav-button.png)

From here, click the **Connect Account** button to connect your GitHub Account.

If connected successfully, you will be redirected to the [Flatiron School][]
landing page. If you head back to the [Connected Apps][] you will see your
GitHub account name displayed.
...
![sign in to console](https://curriculum-content.s3.amazonaws.com/environment-setup/cloud9-sign-in-to-console.png)

You will be brought to AWS Management Console. Under **Find Services**, search for Cloud9.
...
bookmarking this page to easily get back to it. If you have already created a
Cloud9 IDE, it will be displayed here. In our case, we want to click the
**Create environment** button.

![cloud9 create environment button](https://curriculum-content.s3.amazonaws.com/environment-setup/cloud9-create-environment-button.png)

You will first be asked to give your environment a name and an optional
...
will load in the browser window. It may take a few minutes for AWS to fully
configure things.
...
- On the left side of the screen is your directory navigation. As you work on
  ...
  ![cloud9 directory navigation](https://curriculum-content.s3.amazonaws.com/environment-setup/cloud9-directory-navigation.png)
...
- The central section of the IDE (where you see the welcome page) is where file
  contents will be displayed. Clicking on files in the directory navigation will
  open them up in this section.

  ![cloud9 file contents sections](https://curriculum-content.s3.amazonaws.com/environment-setup/cloud9-file-contents-section.png)
...
The terminal will indicate a number of items are being installed
...
Next, we need to set up the `learn-co` gem so that it is connected to your
Flatiron School account.

In your Cloud9 terminal, run `learn whoami`. You will see a message that you
need an OAuth token in order to connect to the Learn web application.
...
> `https://learn.co`. This is Flatiron School's older online platform and may
...
If everything is configured correctly, you should be all set to start working on
Flatiron School assignments. In fact, this set of instructions will act as your
...
a process where an exact copy is made of a collection of code and files.
...
Now, open your Cloud9 IDE. In the terminal, run the following commands:

```sh
git clone git@github.com:<your-user-name>/cloud9-aws-environment-setup.git
```
...
assignment will be present in the left navigation. Change directory into this
folder to access the assignment files.
...
your work to Canvas each time you do, but the assignment will be marked
...
set to complete assignments in this first phase of the course.
...
If all tests pass, the assignment will be submitted to Canvas and marked as Complete
